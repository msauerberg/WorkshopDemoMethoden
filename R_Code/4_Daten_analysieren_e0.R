...
# Neben der SDR, koennen wir Lebenserwartungen berechnen und diese
# Werte als altersstandardisierten Mortalitaetsindikator verwenden  
...
# Welches Bundesland hatte den groeßten Rueckgang in der Lebenserwartung
# zwischen 2019 und 2021?

# Waehle die entsprechenden Jahre und Spalten
...
# Rankings? Sortiere von der gr0eßten negativen Zahl zur kleinsten
e0.ranking.f <- arrange(e0.wide, Diff.f)$PopName
e0.ranking.m <- arrange(e0.wide, Diff.m)$PopName

# Alles in eine Tabelle (funkioniert nur wenn vorher Script 3 ausgefuehrt wurde)
