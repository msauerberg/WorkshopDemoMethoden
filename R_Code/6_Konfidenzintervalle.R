...
# Wir koennen CIs auch für die Lebenserwartung berechnen,
# aber die Funktion benoetigt leider Daten in bestimmten Altersgruppen
# 0, 1-4, 5-9, 10-14...90+
...
# Nun koennen wir die Funktion anwenden
LE_CI <- Dx_Ex_umverteilt %>% group_by(PopName, Year, Sex) %>%
  phe_life_expectancy(Dx, Ex, Age)

# Obwohl wir etwas umverteilt haben, sind die e0 Werte seeeehr aehnlich
...
# Recht kleine CI, aber für das Saarland oder Bremen groeßer
